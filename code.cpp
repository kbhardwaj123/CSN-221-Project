...
class Dual_Data_Cache_List {
  ...
  public:
  Dual_Data_Cache_List(): front(NULL), rear(NULL) {}
...
class Dual_Data_Cache{
  int capacity, size;
  Dual_Data_Cache_List *pageList;
  map<int, Node*> pageMap;

  public:
    Dual_Data_Cache(int capacity) {
      this->capacity = capacity;
      size = 0;
        pageList = new Dual_Data_Cache_List();
...
int main() {
  Dual_Data_Cache cache(2);  // cache capacity 2
  cache.put(2,2);
